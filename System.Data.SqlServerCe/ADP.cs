...
namespace System.Data.SqlServerCe
{
  internal class ADP
  {
    ...
    internal const int SSCE_M_FILESHAREVIOLATION = 25035;
    ...
    internal static IntPtr IntPtrOffset(IntPtr pbase, int offset) => 4 == IntPtr.Size ? (IntPtr) (pbase.ToInt32() + offset) : (IntPtr) (pbase.ToInt64() + (long) offset);
    ...
    internal class DstComparer : IEqualityComparer<string>
    {
      ...
      public bool Equals(string strA, string strB) => 0 == CultureInfo.InvariantCulture.CompareInfo.Compare(strA, strB, CompareOptions.IgnoreCase | CompareOptions.IgnoreKanaType | CompareOptions.IgnoreWidth);
