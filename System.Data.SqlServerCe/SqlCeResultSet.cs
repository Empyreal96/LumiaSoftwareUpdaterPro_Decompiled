...
namespace System.Data.SqlServerCe
{
  public class SqlCeResultSet : SqlCeDataReader, IEnumerable, IListSource
  {
    ...
    public bool ReadAbsolute(int position)
    {
      ...
      return position < 0 && Math.Abs(position) <= bookmarkArray.Count && this.GotoRow(bookmarkArray[bookmarkArray.Count + position]);
    }
    ...
    public override SqlBoolean GetSqlBoolean(int ordinal) => this.HasColumnChanged(ordinal) ? this.sqlUpdatableRecord.GetSqlBoolean(ordinal) : base.GetSqlBoolean(ordinal);

    public override SqlMoney GetSqlMoney(int ordinal) => this.HasColumnChanged(ordinal) ? this.sqlUpdatableRecord.GetSqlMoney(ordinal) : base.GetSqlMoney(ordinal);

    public override SqlDecimal GetSqlDecimal(int ordinal) => this.HasColumnChanged(ordinal) ? this.sqlUpdatableRecord.GetSqlDecimal(ordinal) : base.GetSqlDecimal(ordinal);

    public override SqlByte GetSqlByte(int ordinal) => this.HasColumnChanged(ordinal) ? this.sqlUpdatableRecord.GetSqlByte(ordinal) : base.GetSqlByte(ordinal);

    public override SqlBinary GetSqlBinary(int ordinal) => this.HasColumnChanged(ordinal) ? this.sqlUpdatableRecord.GetSqlBinary(ordinal) : base.GetSqlBinary(ordinal);

    public override SqlDateTime GetSqlDateTime(int ordinal) => this.HasColumnChanged(ordinal) ? this.sqlUpdatableRecord.GetSqlDateTime(ordinal) : base.GetSqlDateTime(ordinal);

    public override SqlDouble GetSqlDouble(int ordinal) => this.HasColumnChanged(ordinal) ? this.sqlUpdatableRecord.GetSqlDouble(ordinal) : base.GetSqlDouble(ordinal);

    public override SqlSingle GetSqlSingle(int ordinal) => this.HasColumnChanged(ordinal) ? this.sqlUpdatableRecord.GetSqlSingle(ordinal) : base.GetSqlSingle(ordinal);

    public override SqlGuid GetSqlGuid(int ordinal) => this.HasColumnChanged(ordinal) ? this.sqlUpdatableRecord.GetSqlGuid(ordinal) : base.GetSqlGuid(ordinal);

    public override SqlInt16 GetSqlInt16(int ordinal) => this.HasColumnChanged(ordinal) ? this.sqlUpdatableRecord.GetSqlInt16(ordinal) : base.GetSqlInt16(ordinal);

    public override SqlInt32 GetSqlInt32(int ordinal) => this.HasColumnChanged(ordinal) ? this.sqlUpdatableRecord.GetSqlInt32(ordinal) : base.GetSqlInt32(ordinal);

    public override SqlInt64 GetSqlInt64(int ordinal) => this.HasColumnChanged(ordinal) ? this.sqlUpdatableRecord.GetSqlInt64(ordinal) : base.GetSqlInt64(ordinal);

    public override SqlString GetSqlString(int ordinal) => this.HasColumnChanged(ordinal) ? this.sqlUpdatableRecord.GetSqlString(ordinal) : base.GetSqlString(ordinal);
