...
// Type: Microsoft.LsuPro.UpdatePackageOs
...
{
  public class UpdatePackageOs
  {
    public UpdatePackageOs(UpdatePackage package) => this.Package = package;
    ...
    public string OsVersion => this.Package.OsVersion;
    ...
    public override string ToString() => this.Package.OsVersion;
  }
}
