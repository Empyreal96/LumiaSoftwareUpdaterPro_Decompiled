...
// Type: Nokia.Lucid.Diagnostics.DeviceDetectionTraceEventId
...
{
  internal enum DeviceDetectionTraceEventId
  {
    FilterExpressionCompilation,
    FilterExpressionEvaluation,
    DeviceChangeEvent,
