...
label_34:
          if ((index2 & 32) != 0)
          {
            int num8 = z.AvailableBytesIn - availableBytesIn;
            int num9 = num2 >> 3 < num8 ? num2 >> 3 : num8;
            int num10 = availableBytesIn + num9;
            int num11 = nextIn - num9;
            int num12 = num2 - (num9 << 3);
            s.bitb = num1;
            s.bitk = num12;
            z.AvailableBytesIn = num10;
            z.TotalBytesIn += (long) (num11 - z.NextIn);
            z.NextIn = num11;
            s.writeAt = destinationIndex;
            return 1;
          }
